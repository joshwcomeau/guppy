...
type Props = {
  currentStep: 'projectName' | 'projectType' | 'projectIcon' | 'done',
  activeField: 'projectName' | 'projectType' | 'projectIcon',
    ...
    return (
      <IntroWrapper>
        <FadeIn key="intro-t">
          ...
          <Paragraph>Let's start by giving your new project a name.</Paragraph>
        </FadeIn>
        {shouldShowRandomizationHint && (
      ...
      return (
        <Fragment>
          <FadeIn key="s2t">
            ...
            <Paragraph>
              React.js uses create-react-app, a flexible development environment
              for building web applications of all types.
            </Paragraph>
            <Paragraph>
              Gatsby is a static site generator for React.js, and is an awesome
              choice
            </Paragraph>
          </FadeIn>
        </Fragment>
